...
export default function Reveal({ children, className = "", delay = 0, as = "div" }: Props) {
  ...
  // Üç etiket için tek ref: React.RefObject<HTMLElement> her birine
  // atanamıyor, o yüzden gevşetiliyor.
  const r = ref as React.RefObject<HTMLDivElement & HTMLLIElement & HTMLElement>;
